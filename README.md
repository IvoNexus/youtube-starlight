...
This is the release repository for Yotube-Starlight, a easy to use youtube-dl and ffmpeg add-on for Windows.
...
This application as it is cannot break, harm or compromise copyrighted material, therefore is fully compliant with the applicable law.
It's made for testing purposes only! Please, respect the artists, if you like their work and talent, support them by purchasing it from official store/e-store.
...
## :pushpin: Credits
I want to express my gratitude to both dev teams of [youtube-dl](https://github.com/ytdl-org/youtube-dl) and [ffmpeg](https://github.com/FFmpeg/FFmpeg) and entire community, which work so hard to provide us with such amazing tools! If you have chance support their work! Keep up the good work guys!

## :computer: Dev Notes
Let's start with the most obvious question - why starlight, because it's my light at the end of the road. I'm a music freak, I love music, I love to discover new artists and can't live without music. There are two main reasons why I created [Starlight](https://github.com/IvoNexus/youtube-starlight), I usually travel to remote areas where internet is not available most of the time, I know most streaming platforms provide an option for offline use well, yes and no, because some of them need verification from time to time, so I decided to take the control in my hands. The second reason, most of the artists I listen are not that popular and are all over the place, put the subscription plans aside, I don't want to use 5 different platforms/applications to do the same thing, so here we are - I unify it.
